...
export const roadSignValidationSchema = Yup.object({
  ...
  faces_number: Yup.number().required("عدد الوجوه مطلوب").min(1, "يجب أن يكون عدد الوجوه أكبر من 0"),
  advertising_meters: Yup.number().required("عدد أمتار الإعلان مطلوب").min(0, "يجب أن يكون عدد أمتار الإعلان 0 أو أكثر"),
  printing_meters: Yup.number().required("عدد أمتار الطباعة مطلوب").min(0, "يجب أن يكون عدد أمتار الطباعة 0 أو أكثر"),
