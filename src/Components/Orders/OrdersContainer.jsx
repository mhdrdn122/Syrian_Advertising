...
const OrdersContainer = () => {
  ...
  const [confirmOrder, { isLoading: iLoadingConfirm }] = useConfirmOneOrderMutation();
    ...
    <div className="p-4 sm:p-6 max-w-full mx-auto space-y-6 bg-background rounded-lg shadow-sm dark:shadow-gray-800">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="flex flex-col">
          <label className="mb-2 text-sm font-medium text-foreground">نوع الطلب</label>
        ...
        {/* City Filter */}
        <div className="flex flex-col">
          <label className="mb-2 text-sm font-medium text-foreground">المدينة</label>
          <select
            value={cityId}
        ...
        {/* Region Filter */}
        <div className="flex flex-col">
          <label className="mb-2 text-sm font-medium text-foreground">المنطقة</label>
          <select
            value={regionId}
        ...
        {/* Date Filter */}
        <div className="flex flex-col">
          <label className="mb-2 text-sm font-medium text-foreground">تاريخ العملية</label>
          <input
            type="date"
            value={actionDate}
      ...
      <DeleteDialog
        ...
        title={
          isConfirmAction ? "عملية تأكيد الطلب" : "عملية إلغاء تأكيد الطلب"
        }
        description={`هل تريد ${
