...
const RoadSignsTable = ({ roadSigns, isLoadingRoadSigns, addToCart, addedSignIds }) => {
  return (
    <div className="mt-8">
      <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-4">اللوحات الطرقية</h2>
        ...
        <Table>
          ...
          <TableBody>
            {isLoadingRoadSigns ? (
              ...
              roadSigns?.map((sign) => (
                <TableRow key={sign.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
