...
const BookingForm = ({ formik, customers, isLoadingCustomers }) => {
  return (
    <form onSubmit={formik.handleSubmit} className="space-y-8 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">الزبون</label>
          <Select
